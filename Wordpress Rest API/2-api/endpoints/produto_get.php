...
function produto_scheme($slug) {
  ...
  if($post_id) {
    ...
    $response = new WP_Error('naoexiste', 'Produto nao encontrado.', array('status' => 404));
  }
...
function api_produtos_get($request) {
  ...
  // mandar para o front apenas os itens que nao foram vendidos ainda
  $vendido = array(
    'key' => 'vendido',
    'value' => 'false',
    'compare' => '='
